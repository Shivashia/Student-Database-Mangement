...
#================================droplist======================================
  ...
  label33=Label(main,text="REMAINING FEE", font=("arial",17))
...
def delete():
    box=tkinter.messagebox.askyesno("WARNING","DATA WILL NOT BE RECOVERED AGAIN")
...
On Tue, Apr 7, 2020 at 9:22 PM Shiv Avashia <shivashia12@gmail.com> wrote:
Isme mene har jagah comments daale hai
kaha konsa function kaam kar raha hai
kis window ka hai
to thoda easy hojayega teko smjhna
